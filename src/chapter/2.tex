...
This chapter will describe the \textit{two types} of mutations involved in cancer development and the challenges associated with distinguishing between them.
