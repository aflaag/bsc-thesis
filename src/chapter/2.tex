...
placeholder \todo{introduction to the chapter, also change chapter name?}
...
To define an equation that mathematically assesses mutual exclusivity and coverage of a given gene set $M$, the formalization should reflect the following properties (discussed in previous sections \todo{add ref?}):
