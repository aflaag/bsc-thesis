...
placeholder. \todo{abstract}

\section{Cancer}

\subsection{TODO}

placeholder. \todo{introduzione da fare}
...
placeholder. \todo{aggiungere paragrafo conclusivo}

\subsection{Mutations and cancer development}
...
Due to the various side effects associated with current cancer treatments, a new form of therapy has recently become the focus of extensive research for its potential to precisely target cancer cells and minimize damage to healthy cells and tissue \cite{target_therapy1}.
...
\subsection{Targeted therapy and mutations}

placeholder. \todo{paragrafo che dice che la tt è utile anche per il discorso delle mutazioni}
