...
This procedure is extensive, but it can be divided into smaller sections. However, before delving into its explanation, it is necessary to introduce and discuss the following definitions.

placeholder \todo{spiega cos'è $G$}
