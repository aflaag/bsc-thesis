...
All these findings highlight the ability of the MCMC algorithm to identify significant gene sets related to known cancer pathways. The following section will introduce an alternative approach to solving the MWSP, and will provide an extension of the problem.
